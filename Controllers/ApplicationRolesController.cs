...
namespace AuctionProject.Controllers
{
    public class ApplicationRolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Descriptions,Id,Name,Descriptions")] ApplicationRole applicationRole)
        {
            if (ModelState.IsValid)
            {
                applicationRole.NormalizedName = applicationRole.Name;
                applicationRole.ConcurrencyStamp = applicationRole.Name;
